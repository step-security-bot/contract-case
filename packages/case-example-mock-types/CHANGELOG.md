...
## [0.16.0](https://github.com/case-contract-testing/contract-case/compare/@contract-case/case-example-mock-types-v0.15.7...@contract-case/case-example-mock-types-v0.16.0) (2024-06-11)
...
* The following workspace dependencies were updated
  ...
  * devDependencies
    ...
    * @contract-case/test-equivalence-matchers bumped from 0.15.7 to 0.16.0
    * @contract-case/case-core-plugin-http-dsl bumped from 0.15.7 to 0.16.0
  * peerDependencies
    * @contract-case/test-equivalence-matchers bumped from 0.15.7 to 0.16.0
